...
python3 -m verl.trainer.main_ppo \
        ...
        actor_rollout_ref.model.path=<PATH_TO_MODEL_CHECKPOINT> \
        ...
        trainer.experiment_name='qwen3_4b_opd-step100-grpo-non_thinking_deepmath_filtered_level6_grpo_bsz128_n8_lr1e-6' \
        trainer.n_gpus_per_node=8 \
        trainer.nnodes=1 \
        trainer.save_freq=10 \
        trainer.default_local_dir=/G-OPD-checkpoints/Qwen3-4B-OPD-Step-100-GRPO-Non-Thinking-DeepMath-filtered-level6-GRPO-1e-6-BSZ-128-n8-u0.75 \
